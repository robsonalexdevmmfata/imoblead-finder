...
const frame = Number(process.argv[2] ?? 120);
...
await renderStill({ composition, serveUrl: bundled, output: `/tmp/f${frame}.png`, frame, puppeteerInstance: browser, overwrite: true });
